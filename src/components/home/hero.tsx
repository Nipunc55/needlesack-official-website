            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    'Pushing boundaries in mobile gaming and revolutionizing web experiences with cutting-edge 3D development. We create immersive worlds that captivate and engage users, delivering unforgettable digital adventures with innovative technology.'
                  }
                </Typography>
              </Box>
              {/* <Box sx={{ '& button': { mr: 2 } }}>
